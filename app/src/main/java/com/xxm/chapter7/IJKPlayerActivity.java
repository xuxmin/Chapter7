...
import com.xxm.chapter7.player.VideoPlayerIJK;
import com.xxm.chapter7.player.VideoPlayerListener;
...
public class IJKPlayerActivity extends Activity implements View.OnClickListener {
    ...
    private boolean vsbVolVisble = false;

    private Handler handler;
    public static final int MSG_REFRESH = 1001;
    private static int initVolumn = 50;
    ...
    private void init() {
        ...
        vsbVol = findViewById(R.id.vsb_vol);
        ...
        // 音量设置
        vsbVol.setProgress(initVolumn);
        vsbVol.setVisibility(View.INVISIBLE);
        vsbVolVisble = false;
        ijkPlayerView.setVolumn(initVolumn);

        vsbVol.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                Log.d("IJKPlayerActivity", String.valueOf(vsbVol.getProgress()));
                ijkPlayer.setVolumn((float) (vsbVol.getProgress() / 100.0));
            }
            ...
            @Override
            public void onStopTrackingTouch(SeekBar seekBar) {
                // ijkPlayer.setVolumn(vsbVol.getProgress() / 100);
            }
        });
        ...
        btnVol.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.d("IJKPlayerActivity", String.valueOf(vsbVolVisble));


                vsbVol.setVisibility(View.VISIBLE);
                vsbVolVisble = true;

                Log.d("IJKPlayerActivity", "可见?" + String.valueOf(vsbVol.getVisibility()));
                handler.sendEmptyMessageDelayed(MSG_REFRESH, 100);
...
//                break;
    ...
    private void portrait() {
        ...
        btnVol.setVisibility(View.INVISIBLE);
